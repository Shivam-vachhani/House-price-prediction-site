...
const MOBILE_CHART_INNER_HEIGHT_BINS = 300;
const MOBILE_CHART_INNER_HEIGHT = 240;
...
const MarketTrends: React.FC = () => {
  ...
  return (
    <AppShell dashboard>
      ...
      <div
        className="market-root flex-1 flex flex-col min-w-0"
        style={{
          overflow: pageScroll,
          background: BG,
      ...
      >
        ...
        <div
          style={{
            flex: 1,
            padding: isMobile ? "80px 10px" : "12px 16px",
            overflow: pageScroll,
            display: "flex",
          ...
          >
            {KPI_CFG.map((k, i) => (
              ...
              >
                ...
                <div style={{ fontSize: 12, color: k.color, fontWeight: 500 }}>
          ...
          >
            ...
            <div
              style={{
                ...
                display: "flex",
                flexDirection: "column",
                height: isSmall ? MOBILE_CHART_HEIGHT : "100%",
                minHeight: isSmall ? MOBILE_CHART_HEIGHT : undefined,
              }}
            >
              <div
                style={{
              ...
              <div
                style={{
                  flex: isSmall ? "unset" : 1,
                  height: isSmall ? MOBILE_CHART_INNER_HEIGHT_BINS : undefined,
                  minHeight: isSmall ? MOBILE_CHART_INNER_HEIGHT_BINS : 0,
                  overflow: "hidden",
                }}
              >
                <ResponsiveContainer
                  width="100%"
                  height={isSmall ? MOBILE_CHART_INNER_HEIGHT_BINS : "130%"}
                >
                  <BarChart
                    data={locData}
                    margin={{
                  ...
                  {bhkData.map((b) => (
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <span
                          style={{ fontSize: 13, color: TXT, fontWeight: 500 }}
                        >
                          {b.name}
                        </span>
                      </div>
            ...
            >
              ...
              <div
                style={{
                  flex: isSmall ? "unset" : 1,
                  height: isSmall ? MOBILE_CHART_INNER_HEIGHT : undefined,
                  minHeight: isSmall ? MOBILE_CHART_INNER_HEIGHT : 0,
                  overflow: "hidden",
                }}
              >
                <ResponsiveContainer
                  width="100%"
                  height={isSmall ? MOBILE_CHART_INNER_HEIGHT : "100%"}
                >
                  <ScatterChart
