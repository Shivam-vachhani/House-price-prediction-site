...
const CompareModels: React.FC = () => {
  ...
  return (
    <AppShell dashboard mainBg={BG}>
      ...
      <div
        className="cm-root flex-1 flex flex-col min-w-0"
        style={{
          background: BG,
          overflow: "hidden",
      ...
      >
        ...
        <div
          style={{
            ...
            overflowY: "auto",
            overflowX: "hidden",
            // paddingTop clears fixed mobile navbar; no extra spacer div needed
            paddingTop: isSmall ? 78 : 12,
            paddingBottom: 12,
            ...
            {stats.map((m) => {
              ...
              return (
                <div
                  ...
                  style={{
                    // On mobile: equal flex width so all 3 sit in one row
                    flex: isMobile ? 1 : "unset",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: isMobile ? "center" : "flex-start",
                    gap: 6,
                    padding: isMobile ? "8px 4px" : "8px 14px",
                    borderRadius: 10,
                    border: isSel
                ...
                >
                  ...
                  {!isWin && m.model === "Random Forest" && !isMobile && (
                    <span
                      style={{
                        fontSize: 12,
                        background: "#fef9c3",
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 12, color: EMERALD, fontWeight: 600 }}>
                  ■ = best value
                </span>
              </div>
            </div>
              ...
              <ResponsiveContainer width="100%" height={500}>
                ...
                >
                    ...
                    content={({ active, payload }: any) => {
                      ...
                      return (
                        <div style={tip}>
                          ...
                          <div
                            style={{ color: err < 50 ? "#4ade80" : "#fbbf24" }}
                          >
                            Δ {fmtP(err)}
                          </div>
                        </div>
                  ...
                  <Scatter data={avpData} opacity={0.6}>
                    {avpData.map((d, i) => {
                      const err = Math.abs(d.actual - d.predicted);
                      const mc = MODEL_META[activeModel]?.color ?? ACCENT;
                      return (
                        <Cell
                          key={i}
                          fill={err < 50 ? mc : err < 120 ? AMBER : ROSE}
                        />
                      );
                    })}
                  </Scatter>
